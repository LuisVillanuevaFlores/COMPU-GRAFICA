...
class mostrarImagen(QDialog):
    ...
    def initUI(self):
      ...
      # ================= WIDGETS QPUSHBUTTON ====================
        ...
        buttonThresh = QPushButton("Trhresholding", self)
        buttonThresh.setToolTip("Thresholding")
        buttonThresh.setCursor(Qt.PointingHandCursor)
        buttonThresh.setGeometry(143,75, 120, 25)
  ...
  # ======================= FUNCIONES ============================
    ...
    def seleccionarImagen(self):
        imagen, extension = QFileDialog.getOpenFileName(self, "Seleccionar imagen", getcwd(),"Archivos de imagen (*.png *.jpg)",options=QFileDialog.Options())
